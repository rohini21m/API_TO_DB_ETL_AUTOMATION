...
file_path = os.path.expanduser("/Users/user_name_value/Downloads/Raw_API_file/IBM_raw_data.json")
...
DB_USER = os.getenv("DB_USER", "name")
DB_PASSWORD = os.getenv("DB_PASSWORD", "password_value")
